...
corner dir char matrix =
    ...
    , ( \m -> (SlantRight == m.north) && (Horizontal == m.east)
      , Curve 2 (Ext North West) (Ext South (East_ 2))
      )
    , ( \m -> (SlantLeft == m.north) && (Horizontal == m.west)
      , Curve 2 (Ext North East) (Ext South (West_ 2))
      )
